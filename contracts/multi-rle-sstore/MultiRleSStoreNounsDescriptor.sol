...
contract MultiRleSStoreNounsDescriptor is INounsDescriptor, Ownable {
   ...
   * @dev This function can only be called by the owner when not locked.
   */
  function addManyBodies(bytes[] calldata bodies)
    external
    onlyOwner
    whenPartsNotLocked
  {
   ...
   * @dev This function can only be called by the owner when not locked.
   */
  function setHeads(bytes calldata heads)
    external
    onlyOwner
    whenPartsNotLocked
  {
   ...
   * @dev This function can only be called by the owner when not locked.
   */
  function addManyGlasses(bytes[] calldata glasses)
    external
    onlyOwner
    whenPartsNotLocked
  {
   ...
   * @dev This function can only be called by the owner when not locked.
   */
  function addAccessory(bytes calldata accessory)
    external
    onlyOwner
    whenPartsNotLocked
  {
   ...
   * @dev This function can only be called by the owner when not locked.
   */
  function addGlasses(bytes calldata glasses)
    external
    onlyOwner
    whenPartsNotLocked
  {
